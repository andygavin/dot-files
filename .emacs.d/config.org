...
;; REPL history file
(setq cider-repl-history-file (concat init/emacsd "/cider-history"))
...
* Rust
Rust looks to be a promising language, with some quite innovative features.  Many say that it's up
